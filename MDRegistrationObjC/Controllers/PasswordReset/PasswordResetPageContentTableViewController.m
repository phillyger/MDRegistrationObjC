//
//  PasswordResetPageContentTableViewController.m
//  MDRegistrationObjC
//
...
@interface PasswordResetPageContentTableViewController ()
...
@implementation PasswordResetPageContentTableViewController
- (void)viewDidLoad {
    [super viewDidLoad];
